# Generated by Powerlevel10k configuration wizard on 2022-11-11 at 17:05 MST.
...
# solid, no frame, lightest-ornaments, sparse, many icons, fluent, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|argo|argocd'
